hello-msg =
    ...
    Если ты решил просто использовать функционал этого бота, то воспользуйся следующими командами:
    • /mnenie: Узнать последние новости
    • /feedback: Написать отзыв по боту
